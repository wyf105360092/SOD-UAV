...
def get_params():
    params = {
        'weight': 'runs/train//Baseline/weights/best.pt',
        'cfg': 'cfg/improved/yolov7-coupling.yaml',
        # 'weight': 'runs/train/Proposed Model/weights/best.pt',
        # 'cfg': 'cfg/improved/yolov7-bifpn2s-dyhead2.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model('inference/vis2.jpg', 'result')