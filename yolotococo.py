...
parser.add_argument('--root_dir', default='E:\\dataset\\VisDrone2019\\VisDrone2019-DET-test-dev',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
